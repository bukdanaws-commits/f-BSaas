        ...
        <CardContent>
          {scanResult ? (
            <div className="space-y-4">
              ...
              <div className={`p-4 rounded-lg ${scanResult.success ? 'bg-green-50 dark:bg-green-900/20 text-green-800 dark:text-green-400' : 'bg-red-50 dark:bg-red-900/20 text-red-800 dark:text-red-400'}`}>
